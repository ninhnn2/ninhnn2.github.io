...
|---|---|---|---|
| **Token embedding** | một mảnh từ (token) | 96-4096 | `tok_emb.weight[id]` tại [`model.py:156`](https://github.com/ninhnn2/machineai/blob/main/src/model.py#L156) |
...
vocab 4096. Bản deploy thật lên ESP32-S3 trong [`RESULTS.md`](https://github.com/ninhnn2/machineai/blob/main/RESULTS.md) dùng
