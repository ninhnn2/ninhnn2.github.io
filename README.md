...
Chào mừng đến với blog của tôi, nơi chia sẻ kiến thức và kinh nghiệm thực chiến về **lập trình nhúng**: Linux kernel, device driver, U-Boot, Yocto / Buildroot / OpenWrt, Android BSP và IoT. Gần đây thêm **AI cho kỹ sư nhúng**: chạy một mô hình ngôn ngữ 28,9 triệu tham số trên con chip ESP32-S3 giá 8 đô.
...
- SoC MT7628 với 64 MB DRAM, 32 MB NOR flash, chạy OpenWrt
